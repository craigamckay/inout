...
//
// 2020-09-15, feuerri - 2.2.7 - PHP7 updates.
...
// Set the default timezone. This is important  if the program is running on
// a server that is in a different TZ than the users. For a list of timezones,
// see http://us.php.net/manual/en/timezones.php .
//
// date_default_timezone_set('US/Central'); /* please uncomment this line and set the Timezone!! */
...
$this->config['installtables'] = false; 	// true or false (no quotes)
...
// NOTE: This path MUST end in a trailing slash. Example: "/tmp/"
$this->config['temp_dir'] = sys_get_temp_dir().DIRECTORY_SEPARATOR; 
...
$this->config['periodstart'] = "2019-01-01";  
...
$this->config['version'] = "2.2.8";            // Don't change this
